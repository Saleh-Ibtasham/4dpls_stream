...
def get_bbox_from_points(points):
    ...
    return [x1,y1,z1,x2,y2,z2], np.array([x1.cpu() + (x2.cpu()-x1.cpu())/2, y1.cpu()+ (y2.cpu()-y1.cpu())/2,z1.cpu()+ (z2.cpu()-z1.cpu())/2, 0, x2.cpu()-x1.cpu(),y2.cpu()-y1.cpu(),z2.cpu()-z1.cpu()]) # x, y, z, theta, l, w, h
